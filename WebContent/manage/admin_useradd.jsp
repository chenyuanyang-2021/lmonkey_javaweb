                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input name="common-text required" id="title"  name="email" size="50" type="text">
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>手机号码：</th>
                                <td><input name="common-text required" id="title"  name="mobile" size="50" type="text">
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>送货地址：</th>
                                <td><input name="common-text required" id="title"  name="address" size="50" type="text">
                            </tr>
